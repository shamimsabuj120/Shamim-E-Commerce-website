...
def payment(request):
    ...
    store_id = 'suvas6446732271839'
    API_key = 'suvas6446732271839@ssl'
    ...
    mypayment.set_customer_info(name=current_user.profile.full_name, email=current_user.email, address1=current_user.profile.address_a, address2=current_user.profile.address_a,
